...
xhrRequest.open(
  "get",
  "https://gateway.marvel.com/v1/public/characters?ts=1&apikey=caa6231ec49cdeb2b76cc80109ea2c73&hash=5d32ed5345faf69913344f78202e5d58",
  true
);
xhrRequest.send();
...
function getUrl() {
  ...
  if (!searchQuery) {
    return `https://gateway.marvel.com/v1/public/characters?ts=1&apikey=caa6231ec49cdeb2b76cc80109ea2c73&hash=5d32ed5345faf69913344f78202e5d58`;
  } else {
    return `https://gateway.marvel.com/v1/public/characters?nameStartsWith=${searchQuery}&ts=1&apikey=caa6231ec49cdeb2b76cc80109ea2c73&hash=5d32ed5345faf69913344f78202e5d58`;
  }
}
